...
import com.example.management.payload.request.LoginRequest;
import com.example.management.payload.request.SignupRequest;
import com.example.management.payload.response.JwtResponse;
...
import com.example.management.security.services.UserDetailsImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getUsername(),
                ...
                encoder.encode(signUpRequest.getPassword()), 12L);
